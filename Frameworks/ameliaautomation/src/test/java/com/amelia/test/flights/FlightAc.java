...
public class FlightAc extends Base {
	...
	public void oneWayFlightSearch(@Optional("https://www.flipkart.com") String url)
		...
		cs.navigate_url(
				"https://www.flipkart.com/travel/search/result/flight/BLR/HYD/09092020//1/0/0/e?source=Expire%20Popup");
		Thread.sleep(3000);

		cs.clickOnWebElement(fhp.nonStopPreference);
		
		Assert.assertTrue("Nonstop preference is desabled by default", true);
