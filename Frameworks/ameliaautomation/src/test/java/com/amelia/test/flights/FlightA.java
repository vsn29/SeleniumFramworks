...
public class FlightA extends Base {

	@Test
	@Parameters({ "url" })
	public void verifySearchFeature(@Optional("https://www.flipkart.com") String url)
		...
		ExtentTest reports = new ExtentTest("Demo", "Test1");
		String price;
		...
		Thread.sleep(3000);
		reports.log(LogStatus.PASS, "Selected From City.");
		...
		reports.log(LogStatus.PASS, "Selected to City.");
		...
		reports.log(LogStatus.PASS, "Testcase is passed");
	}
}